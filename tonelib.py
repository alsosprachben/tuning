...
class SplashCymbalProperties(CymbalProperties):
    ...
    # ring time peaks in the middle and dies at both ends, which the inherited
    # monotonic law cannot express.
    mode_ratios = (1.0000, 1.0304, 1.0313, 1.0316, 1.0678, 1.0695, 1.1324, 1.1569,
                   1.1755, 1.2087, 1.2472, 1.2615, 1.2670, 1.2817, 1.3218, 1.3288,
                   1.3502, 1.3910, 1.3915, 1.4078, 1.4093, 1.4978, 1.5215, 1.5554,
                   1.6132, 1.6398, 1.6536, 1.7013, 1.7469, 1.7663, 1.8130, 1.8497,
                   1.8550, 1.9045, 1.9838, 2.0751, 2.0803, 2.1255, 2.1924, 2.2054,
                   2.2548, 2.2683, 2.3113, 2.3701, 2.4085, 2.5709, 2.6007, 2.6170,
                   2.6315, 2.7112, 2.8453, 2.8932, 2.9114, 2.9859, 3.0051, 3.1081,
                   3.1235, 3.1418, 3.1485, 3.2014, 3.2138, 3.2503, 3.2697, 3.2707,
                   3.3164, 3.4108, 3.4209, 3.4294, 3.4638, 3.5538, 3.6112, 3.7353,
                   3.7422, 3.8172, 3.9611, 3.9640, 3.9686, 4.0777, 4.2599, 4.2680,
                   4.4120, 4.6526, 4.7214, 4.7239, 4.7415, 4.8592, 5.0300, 5.1560,
                   5.2769, 5.3844, 5.4050, 5.4375, 5.4827, 5.5015, 5.7677, 5.7982,
                   6.2549, 6.2605, 6.2757, 6.4435, 6.5403, 6.7619, 6.7906, 6.9045,
                   6.9460, 7.0034, 7.0747, 7.3083, 7.5905, 7.5940, 7.6926, 7.8325,
                   7.9941, 8.0407, 8.0687, 8.0883, 8.2489, 8.3151, 8.5722, 8.7363,
                   8.8262, 8.9789, 9.0064, 9.1544, 9.4536, 9.6447, 9.7805, 9.9761,
                   10.0424, 10.2223, 10.5324, 10.7316, 10.8971, 11.1923, 11.3815,
                   11.4369, 11.4602, 11.5342, 11.5739, 11.9680, 12.0317, 12.1024,
                   12.7758, 12.9387, 13.7072, 13.7335, 14.2326, 14.2503, 14.7200,
                   14.8022, 14.8363, 15.9492, 16.0333, 16.1595, 16.4237, 16.4741,
                   16.5581, 17.3677, 17.7069, 17.9324, 18.0236, 18.0330, 18.3644,
                   18.4091, 19.8957, 20.4813, 20.7539, 20.8452, 21.1172, 21.4556,
                   21.7191, 22.6115, 22.7696, 22.8985, 23.2998, 23.8424, 24.9524,
                   25.1272, 26.3402, 26.5220, 26.9244, 27.7017, 28.0803, 28.2368,
                   28.5273, 30.6634, 30.8529, 31.1346, 31.3988, 32.6726, 33.1469,
                   33.3609, 33.8111, 33.9195, 36.2183, 37.8518, 38.0121, 38.3553,
                   38.5909, 39.2934)
    mode_gains  = (0.0292, 0.0257, 0.0256, 0.0256, 0.0237, 0.0236, 0.0191, 0.0171,
                   0.0154, 0.0140, 0.0143, 0.0146, 0.0147, 0.0150, 0.0149, 0.0152,
                   0.0184, 0.0206, 0.0206, 0.0207, 0.0206, 0.0241, 0.0237, 0.0244,
                   0.0264, 0.0267, 0.0264, 0.0251, 0.0255, 0.0269, 0.0289, 0.0291,
                   0.0290, 0.0282, 0.0459, 0.0655, 0.0663, 0.0727, 0.0732, 0.0712,
                   0.0650, 0.0721, 0.0911, 0.1075, 0.1145, 0.1517, 0.1630, 0.1762,
                   0.1920, 0.2819, 0.4408, 0.4428, 0.4423, 0.6078, 0.6580, 0.9653,
                   0.9761, 0.9817, 0.9838, 0.9997, 1.0000, 0.9987, 0.9980, 0.9980,
                   0.9792, 0.8578, 0.8314, 0.8084, 0.7077, 0.5494, 0.5096, 0.4806,
                   0.4789, 0.4603, 0.3372, 0.3350, 0.3313, 0.2558, 0.2525, 0.2520,
                   0.2537, 0.2074, 0.2092, 0.2095, 0.2120, 0.2322, 0.2878, 0.3304,
                   0.3417, 0.3425, 0.3427, 0.3426, 0.3368, 0.3344, 0.2750, 0.2660,
                   0.1592, 0.1579, 0.1544, 0.1214, 0.1116, 0.1047, 0.1033, 0.1079,
                   0.1192, 0.1334, 0.1491, 0.2925, 0.4045, 0.4052, 0.4246, 0.4388,
                   0.4391, 0.4266, 0.4190, 0.4136, 0.3616, 0.3333, 0.2316, 0.1768,
                   0.1508, 0.1002, 0.0975, 0.0814, 0.0645, 0.0634, 0.0640, 0.0723,
                   0.0749, 0.1036, 0.1924, 0.2414, 0.2511, 0.2531, 0.2482, 0.2459,
                   0.2449, 0.2418, 0.2401, 0.1488, 0.1289, 0.1205, 0.1089, 0.1169,
                   0.2474, 0.2507, 0.2813, 0.2818, 0.2743, 0.2670, 0.2624, 0.1681,
                   0.1728, 0.1867, 0.2343, 0.2423, 0.2551, 0.3480, 0.3441, 0.3298,
                   0.3239, 0.3233, 0.2970, 0.2931, 0.1779, 0.1845, 0.1877, 0.1887,
                   0.1875, 0.1795, 0.1692, 0.1246, 0.1219, 0.1196, 0.1178, 0.1131,
                   0.1010, 0.1002, 0.0758, 0.0666, 0.0657, 0.0691, 0.0720, 0.0729,

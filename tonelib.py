...
class ClosedHiHatProperties(HiHatProperties):
    ...
    """
    mode_gains = (0.0268, 0.0237, 0.0105, 0.0110, 0.0110, 0.0028, 0.0041, 0.0041,
                   0.0033, 0.0012, 0.0027, 0.0025, 0.0026, 0.0050, 0.0040, 0.0031,
                   0.0042, 0.0030, 0.0071, 0.0076, 0.0065, 0.0049, 0.0060, 0.0076,
                   0.0037, 0.0034, 0.0011, 0.0021, 0.0024, 0.0034, 0.0032, 0.0024,
                   0.0023, 0.0035, 0.0075, 0.0130, 0.0073, 0.0106, 0.0069, 0.0061,
                   0.0057, 0.0075, 0.0418, 0.0076, 0.0057, 0.0067, 0.0083, 0.0088,
                   0.0053, 0.0058, 0.0074, 0.0124, 0.0116, 0.0082, 0.0061, 0.0061,
                   0.0103, 0.0125, 0.0192, 0.0104, 0.0094, 0.0218, 0.0049, 0.0095,
                   0.0394, 0.0122, 0.0072, 0.0105, 0.0158, 0.0126, 0.0092, 0.0167,
                   0.0138, 0.0112, 0.0967, 0.0132, 0.0124, 0.0104, 0.0106, 0.0111,
                   0.0142, 0.0283, 0.0376, 0.0265, 0.0123, 0.0174, 0.0243, 0.0260,
                   0.0270, 0.0306, 0.0711, 0.0159, 0.0101, 0.0183, 0.0151, 0.0135,
                   0.0156, 0.0170, 0.0117, 0.0159, 0.0094, 0.0092, 0.0154, 0.0117,
                   0.0167, 0.0172, 0.0228, 0.0227, 0.0264, 0.0244, 0.0357, 0.0154,
                   0.0443, 0.0491, 0.0290, 0.0180, 0.0191, 0.0131, 0.0289, 0.0194,
                   0.0185, 0.0159, 0.0250, 0.0382, 0.0385, 0.0536, 0.0744, 0.0486,
                   0.0387, 0.0426, 0.0398, 0.0216, 0.0280, 0.0148, 0.0267, 0.0462,
                   0.0446, 0.0270, 0.0227, 0.0447, 0.0275, 0.0559, 0.0443, 0.0237,
                   0.0503, 0.0600, 0.0526, 0.0457, 0.0634, 0.0937, 0.0551, 0.0998,
...
class PedalHiHatProperties(HiHatProperties):
    ...
    """
    mode_gains = (0.0363, 0.0198, 0.0110, 0.0083, 0.0105, 0.0048, 0.0076, 0.0053,
                   0.0035, 0.0033, 0.0031, 0.0049, 0.0055, 0.0058, 0.0015, 0.0026,
                   0.0011, 0.0033, 0.0038, 0.0026, 0.0038, 0.0022, 0.0013, 0.0011,
                   0.0011, 0.0017, 0.0013, 0.0012, 0.0025, 0.0023, 0.0015, 0.0015,
                   0.0009, 0.0021, 0.0026, 0.0030, 0.0028, 0.0037, 0.0028, 0.0047,
                   0.0032, 0.0051, 0.0137, 0.0103, 0.0045, 0.0033, 0.0052, 0.0031,
                   0.0045, 0.0019, 0.0026, 0.0036, 0.0074, 0.0055, 0.0011, 0.0039,
                   0.0050, 0.0032, 0.0038, 0.0044, 0.0045, 0.0321, 0.0038, 0.0109,
                   0.0166, 0.0123, 0.0037, 0.0044, 0.0067, 0.0062, 0.0041, 0.0054,
                   0.0057, 0.0062, 0.0279, 0.0098, 0.0053, 0.0091, 0.0072, 0.0096,
                   0.0081, 0.0146, 0.0112, 0.0138, 0.0119, 0.0153, 0.0052, 0.0170,
                   0.0214, 0.0247, 0.0498, 0.0242, 0.0122, 0.0122, 0.0092, 0.0132,
                   0.0195, 0.0144, 0.0087, 0.0132, 0.0150, 0.0200, 0.0107, 0.0197,
                   0.0117, 0.0067, 0.0126, 0.0067, 0.0141, 0.0152, 0.0207, 0.0169,
                   0.0212, 0.0162, 0.0194, 0.0242, 0.0091, 0.0091, 0.0126, 0.0168,
                   0.0194, 0.0252, 0.0157, 0.0229, 0.0220, 0.0297, 0.0358, 0.0308,
                   0.0262, 0.0245, 0.0174, 0.0189, 0.0206, 0.0304, 0.0244, 0.0316,
                   0.0341, 0.0203, 0.0206, 0.0223, 0.0264, 0.0225, 0.0299, 0.0356,
                   0.0704, 0.0308, 0.0321, 0.0277, 0.0313, 0.0692, 0.0301, 0.0873,
...
class OpenHiHatProperties(HiHatProperties):
    ...
    """
    mode_gains = (0.0908, 0.0945, 0.0667, 0.1152, 0.0629, 0.0287, 0.0238, 0.0451,
                   0.0341, 0.0194, 0.0090, 0.0275, 0.0341, 0.0222, 0.0160, 0.0137,
                   0.0067, 0.0147, 0.0196, 0.0245, 0.0419, 0.0242, 0.0160, 0.0233,
                   0.0184, 0.0126, 0.0071, 0.0043, 0.0052, 0.0153, 0.0123, 0.0192,
                   0.0145, 0.0110, 0.0264, 0.0690, 0.0264, 0.0246, 0.0279, 0.0122,
                   0.0358, 0.0257, 0.0248, 0.0093, 0.0093, 0.0213, 0.0466, 0.0431,
                   0.0313, 0.0240, 0.0220, 0.0169, 0.0148, 0.0259, 0.0455, 0.0235,
                   0.0295, 0.0116, 0.0283, 0.0277, 0.0316, 0.1228, 0.0152, 0.0330,
                   0.0684, 0.0382, 0.0343, 0.0495, 0.0371, 0.0392, 0.0178, 0.0828,
                   0.0263, 0.0351, 0.0912, 0.0220, 0.0264, 0.0292, 0.0330, 0.0582,
                   0.0500, 0.0863, 0.0314, 0.0834, 0.0590, 0.0211, 0.0238, 0.0428,
                   0.0444, 0.0646, 0.2126, 0.0236, 0.0238, 0.0417, 0.0510, 0.0210,
                   0.0500, 0.0682, 0.0232, 0.0162, 0.0159, 0.0145, 0.0482, 0.0177,
                   0.0235, 0.0174, 0.0357, 0.0384, 0.0509, 0.0408, 0.0520, 0.0485,
                   0.0758, 0.0705, 0.0478, 0.0584, 0.0335, 0.0310, 0.0642, 0.0635,
                   0.0450, 0.0386, 0.0570, 0.0645, 0.0694, 0.0684, 0.1094, 0.0912,
                   0.0821, 0.0934, 0.0855, 0.0525, 0.0568, 0.0761, 0.0524, 0.0371,
                   0.0410, 0.0573, 0.0453, 0.0342, 0.0602, 0.0752, 0.0414, 0.0431,
                   0.1304, 0.1001, 0.0851, 0.0443, 0.1011, 0.1484, 0.0660, 0.1092,
...
class CrashCymbal1Properties(CymbalProperties):
    ...
    mode_gains  = (0.5638, 0.2082, 0.1974, 0.2834, 0.3266, 0.3876, 0.3876, 0.4736,
                   0.4826, 0.4872, 0.5583, 0.5586, 0.5917, 0.6011, 0.5911, 0.5765,
                   0.5269, 0.4714, 0.4574, 0.4374, 0.4119, 0.3476, 0.3231, 0.3010,
                   0.2208, 0.2132, 0.2035, 0.2017, 0.1431, 0.1425, 0.1379, 0.1349,
                   0.1163, 0.1083, 0.1059, 0.1009, 0.0840, 0.0827, 0.0844, 0.0868,
                   0.0972, 0.1025, 0.1028, 0.1284, 0.2452, 0.2641, 0.3522, 0.3544,
                   0.3835, 0.4661, 0.4722, 0.4744, 0.4676, 0.4659, 0.4487, 0.4415,
                   0.4278, 0.4173, 0.3783, 0.3730, 0.3181, 0.3113, 0.3114, 0.3196,
                   0.3573, 0.7386, 0.8445, 0.9295, 0.9968, 0.9996, 0.9644, 0.9468,
                   0.7672, 0.6787, 0.3079, 0.2841, 0.2500, 0.2454, 0.1799, 0.1765,
                   0.2312, 0.3690, 0.5717, 0.5978, 0.6037, 0.6034, 0.5999, 0.5982,
                   0.5994, 0.5865, 0.5819, 0.5106, 0.4979, 0.4998, 0.5688, 0.5915,
                   0.5918, 0.5988, 0.6784, 0.7046, 0.6963, 0.6845, 0.6397, 0.6333,
                   0.6258, 0.5802, 0.4129, 0.3974, 0.3199, 0.2985, 0.2805, 0.2334,
                   0.2590, 0.2880, 0.2915, 0.3975, 0.4689, 0.5292, 0.5305, 0.5384,
                   0.5439, 0.5409, 0.5379, 0.5209, 0.5109, 0.4971, 0.4276, 0.4269,
                   0.4225, 0.5109, 0.5999, 0.6113, 0.5693, 0.5725, 0.6094, 0.5761,
                   0.5544, 0.4936, 0.4801, 0.4757, 0.4746, 0.4695, 0.4669, 0.4439,
                   0.4390, 0.4170, 0.4127, 0.4410, 0.4747, 0.4837, 0.4965, 0.5091,
                   0.5876, 0.6095, 0.6213, 0.6234, 0.6610, 0.6626, 0.6637, 0.6667,
                   0.7012, 0.7054, 0.7063, 0.7110, 0.7231, 0.7149, 0.6710, 0.5947,
                   0.5773, 0.5222, 0.5354, 0.5492, 0.5345, 0.5303, 0.5206, 0.5115,
                   0.4400, 0.4605, 0.5368, 0.5363, 0.5339, 0.5315, 0.5301, 0.5225,
                   0.6022, 0.6065, 0.6643, 0.7982, 0.7954, 0.7925, 0.7907, 0.7808,
                   0.7763, 0.5241, 0.6142, 0.6089, 0.6086, 0.6073, 0.6022, 0.5952,
                   0.5781, 0.5760, 0.5770, 0.4060, 0.3903, 0.3904, 0.3912, 0.3913,
                   0.3804, 0.3711, 0.3692, 0.3697, 0.3723, 0.3732, 0.3772, 0.3915,
                   0.4028, 0.4113, 0.4192, 0.4207, 0.4300, 0.4460, 0.4627, 0.4718,
                   0.4762, 0.4797, 0.4804, 0.4764, 0.4665, 0.4645, 0.5530, 0.5608,
                   0.5611, 0.5661, 0.5734, 0.5789, 0.5888, 0.5888, 0.5856, 0.5822,
                   0.5808, 0.5826, 0.5828, 0.5873, 0.5875, 0.5878, 0.5787, 0.5709,
                   0.5700, 0.5618, 0.5454, 0.4784, 0.4520, 0.4105, 0.4329, 0.4607,
                   0.4674, 0.4642, 0.4641, 0.4669, 0.4986, 0.5027, 0.5116, 0.5231,
                   0.5284, 0.5880, 0.5947, 0.5968, 0.6057, 0.6096, 0.6173, 0.6293,
                   0.6327, 0.6340, 0.6522, 0.6967, 0.7292, 0.7605, 0.7939, 0.8080,
                   0.8756, 0.8996, 0.9117, 0.9120, 0.9144, 0.9178, 0.9294, 0.9326,
...
class CrashCymbal2Properties(CymbalProperties):
    ...
    # The same window mistake as the hi-hat's mode set and the guiro's, in the
    # third place: measuring the right quantity over the wrong span of the note.
    mode_gains  = (0.1654, 0.1556, 0.0974, 0.1078, 0.1078, 0.1104, 0.1158, 0.1158,
                   0.1159, 0.1159, 0.1157, 0.1157, 0.1965, 0.2575, 0.3040, 0.3850,
                   0.4103, 0.4074, 0.4034, 0.3961, 0.3466, 0.3229, 0.2961, 0.1887,
                   0.1770, 0.1619, 0.1586, 0.1034, 0.1035, 0.1016, 0.0951, 0.0944,
                   0.0923, 0.0910, 0.0839, 0.0738, 0.0642, 0.0518, 0.0495, 0.0520,
                   0.0523, 0.0630, 0.0840, 0.1270, 0.1303, 0.1497, 0.1704, 0.2150,
                   0.2192, 0.2218, 0.2272, 0.2272, 0.2233, 0.2156, 0.1908, 0.1876,
                   0.0861, 0.0828, 0.0790, 0.0774, 0.0734, 0.0810, 0.1730, 0.2549,
                   0.4133, 0.5211, 0.6870, 0.8421, 0.9044, 0.9722, 0.9804, 0.9131,
                   0.8858, 0.8490, 0.8442, 0.7152, 0.6975, 0.6074, 0.4657, 0.2887,
                   0.2435, 0.1925, 0.1876, 0.1925, 0.2498, 0.2795, 0.2850, 0.3464,
                   0.3474, 0.3482, 0.3011, 0.2865, 0.2865, 0.2856, 0.2515, 0.2502,
                   0.1594, 0.1415, 0.2581, 0.2880, 0.3111, 0.3176, 0.3251, 0.3699,
                   0.4606, 0.4615, 0.3269, 0.3075, 0.3049, 0.1950, 0.2305, 0.2526,
                   0.2611, 0.2623, 0.2680, 0.2714, 0.2741, 0.2730, 0.2719, 0.2709,
                   0.2698, 0.2679, 0.2652, 0.2642, 0.2629, 0.2586, 0.1765, 0.1848,
                   0.2441, 0.4888, 0.5031, 0.6733, 1.0000, 0.9998, 0.9936, 0.9713,
                   0.9573, 0.9463, 0.9198, 0.8903, 0.8526, 0.8184, 0.8124, 0.7946,
                   0.5611, 0.3519, 0.3088, 0.3002, 0.3205, 0.4070, 0.4338, 0.4434,
                   0.5581, 0.5574, 0.5572, 0.5565, 0.5554, 0.5461, 0.5459, 0.5174,
                   0.4912, 0.4887, 0.4853, 0.4523, 0.4529, 0.4580, 0.4755, 0.4965,
                   0.4904, 0.4885, 0.5330, 0.5548, 0.5916, 0.5945, 0.6236, 0.6297,
                   0.6365, 0.6864, 0.6856, 0.6829, 0.6664, 0.6428, 0.6365, 0.6010,
                   0.5942, 0.5566, 0.5543, 0.4839, 0.4639, 0.4734, 0.4980, 0.5372,
                   0.5543, 0.5598, 0.5608, 0.5612, 0.5626, 0.5237, 0.5177, 0.4578,
                   0.4563, 0.4480, 0.4373, 0.4251, 0.4208, 0.4104, 0.4157, 0.4255,
                   0.4283, 0.3932, 0.3853, 0.3827, 0.3793, 0.3560, 0.3720, 0.3928,
                   0.4564, 0.5920, 0.6088, 0.6122, 0.6127, 0.6138, 0.6322, 0.6497,
                   0.6449, 0.6402, 0.6313, 0.5346, 0.5112, 0.4584, 0.4480, 0.4432,
                   0.4323, 0.3825, 0.3683, 0.3717, 0.3768, 0.3879, 0.3928, 0.4039,
                   0.4096, 0.4218, 0.4260, 0.4694, 0.4762, 0.4766, 0.4989, 0.4998,
                   0.5325, 0.5309, 0.5023, 0.4971, 0.4792, 0.4662, 0.4250, 0.4300,
                   0.4357, 0.4406, 0.4401, 0.4329, 0.4285, 0.4113, 0.4206, 0.4401,
                   0.5245, 0.5312, 0.5380, 0.5461, 0.5817, 0.5799, 0.5773, 0.5754,
                   0.5678, 0.5577, 0.5602, 0.5609, 0.5637, 0.5916, 0.5969, 0.6059,
                   0.6114, 0.6125, 0.6203, 0.6312, 0.6365, 0.6462, 0.6665, 0.7465,
...
class SplashCymbalProperties(CymbalProperties):
    ...
    mode_gains  = (0.0090, 0.0028, 0.0070, 0.0076, 0.0061, 0.0002, 0.0002, 0.0000,
                   0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0998, 0.0539, 0.0855,
                   0.0710, 0.2571, 1.0000, 0.6412, 0.5715, 0.5179, 0.0979, 0.0405,
                   0.0738, 0.0932, 0.0626, 0.1662, 0.0956, 0.0933, 0.0767, 0.0219,
                   0.0324, 0.0518, 0.0731, 0.1830, 0.0956, 0.1035, 0.1123, 0.6039,
                   0.2066, 0.1685, 0.1648, 0.0782, 0.0682, 0.0958, 0.0789, 0.0774,
                   0.1050, 0.0878, 0.2293, 0.1472, 0.1744, 0.5411, 0.4014, 0.5060,
                   0.1160, 0.0830, 0.0709, 0.1342, 0.2124, 0.1648, 0.1345, 0.2405,
                   0.3484, 0.1476, 0.2411, 0.4439, 0.3351, 0.1202, 0.1301, 0.2073,
                   0.1229, 0.1595, 0.0643, 0.1578, 0.2829, 0.3061, 0.3409, 0.1785,
                   0.2538, 0.1945, 0.4142, 0.3530, 0.1768, 0.1907, 0.2905, 0.1082,
                   0.1816, 0.0858, 0.1044, 0.0983, 0.1608, 0.4035, 0.3403, 0.4515,
                   0.3163, 0.1851, 0.2165, 0.3833, 0.1685, 0.1567, 0.2543, 0.4019,
                   0.4284, 0.1657, 0.0691, 0.0551, 0.0918, 0.1976, 0.2527, 0.1811,
                   0.2754, 0.2184, 0.2157, 0.2430, 0.0637, 0.1176, 0.0979, 0.0890,
                   0.1297, 0.0903, 0.0618, 0.0567, 0.1078, 0.0919, 0.1432, 0.0967,
                   0.0607, 0.0677, 0.1457, 0.0900, 0.1032, 0.1094, 0.1365, 0.1103,
                   0.1553, 0.2257, 0.1473, 0.2116, 0.2509, 0.2042, 0.2850, 0.2182,
                   0.2598, 0.0912, 0.1622, 0.1600, 0.1448, 0.1700, 0.1830, 0.1025,
                   0.1908, 0.1478, 0.2062, 0.1831, 0.1315, 0.1012, 0.0975, 0.2172,
                   0.1494, 0.2441, 0.1887, 0.1165, 0.0495, 0.1542, 0.1245, 0.0592,
                   0.1955, 0.1320, 0.1716, 0.0931, 0.0972, 0.1193, 0.1312, 0.1121,
                   0.1829, 0.1086, 0.0797, 0.1275, 0.1198, 0.1166, 0.1065, 0.1948,
                   0.0843, 0.0755, 0.1025, 0.0610, 0.1449, 0.1587, 0.1135, 0.1732,
                   0.1150, 0.1329, 0.0761, 0.1567, 0.1494, 0.0934, 0.1021, 0.4352)
    max_harmonic = 200
    inharmonicity_coefficient = 0.0
    inharmonicity_dynamic = False
    strike_phase_spread = 1.0
...
class ChineseCymbalProperties(CymbalProperties):
    ...
    mode_gains  = (0.0542, 0.0078, 0.0681, 0.0023, 0.0117, 0.0375, 0.0047, 0.0094,
                   0.0861, 0.0073, 0.0029, 0.0058, 0.0117, 0.3621, 0.0175, 0.0292,
                   0.0204, 0.0507, 0.0970, 0.0328, 0.0418, 0.0224, 0.0254, 0.0462,
                   0.1626, 0.0149, 0.0134, 0.0179, 0.0433, 0.0119, 0.5341, 0.3267,
                   0.4461, 0.4759, 0.1835, 0.1566, 0.0448, 0.0388, 0.0880, 0.0671,
                   0.0820, 0.0895, 0.0701, 0.1104, 0.0609, 0.0797, 0.0406, 0.0297,
                   0.0109, 0.0078, 0.0219, 0.0078, 0.0172, 0.1250, 0.0609, 0.0109,
                   0.0125, 0.0141, 0.0109, 0.0828, 0.1265, 0.0844, 0.0250, 0.0422,
                   0.0172, 0.0844, 0.0406, 0.0156, 0.1125, 0.1843, 0.1406, 0.0281,
                   0.0734, 0.0500, 0.0859, 0.0906, 0.1015, 0.0703, 0.0672, 0.0375,
                   0.0328, 0.0500, 0.0219, 0.0156, 0.0125, 0.0246, 0.0160, 0.0271,
                   0.1330, 0.1502, 0.3411, 0.0443, 0.0135, 0.0825, 0.0443, 0.0825,
                   0.1897, 0.5394, 0.0603, 0.0653, 0.0209, 0.0209, 0.0369, 0.2463,
                   0.0517, 0.0862, 0.2192, 0.0480, 0.0948, 0.1626, 0.1675, 0.2364,
                   0.2894, 0.1847, 0.0468, 0.1983, 0.0345, 0.5665, 0.4052, 0.3485,
                   0.0406, 0.1872, 0.1749, 0.1786, 0.0234, 0.0468, 0.0628, 0.1207,
                   0.0382, 0.2734, 0.0505, 0.0961, 0.4126, 0.0911, 0.2795, 0.0850,
                   0.0800, 0.2894, 0.1699, 0.2086, 0.1313, 0.1322, 0.1029, 0.0209,
                   0.2266, 0.2436, 0.2379, 0.0749, 0.2593, 0.5911, 0.0332, 0.3356,
                   0.4019, 0.2759, 0.2337, 0.3944, 0.1564, 0.3726, 0.0261, 0.1351,
                   0.2375, 0.1232, 0.1417, 0.1616, 0.6001, 0.1612, 0.2981, 0.2232,
                   0.3380, 0.0730, 0.1621, 0.2640, 0.1777, 0.0697, 0.3763, 0.0981,
                   0.1920, 0.2422, 0.2507, 0.1593, 0.1441, 0.2517, 0.0602, 0.2019,
                   0.1066, 0.0953, 0.1412, 0.0844, 0.1806, 0.0943, 0.0796, 0.3602,
                   0.1327, 0.1995, 0.0512, 0.0616, 0.2171, 0.1090, 0.2525, 0.1163,

...
class CrashCymbal1Properties(CymbalProperties):
    ...
    mode_ratios = (1.0000, 1.0890, 1.1210, 1.2190, 1.3650, 1.3875, 1.4218, 1.4261,
                   1.4283, 1.4703, 1.4706, 1.5020, 1.5539, 1.5818, 1.6041, 1.6555,
                   1.6989, 1.7089, 1.7226, 1.7395, 1.7807, 1.7967, 1.8123, 1.8712,
                   1.8773, 1.8847, 1.8861, 1.9955, 1.9990, 2.0310, 2.0572, 2.1454,
                   2.1700, 2.1768, 2.1910, 2.2459, 2.2934, 2.3070, 2.3275, 2.3845,
                   2.4239, 2.4264, 2.4865, 2.5805, 2.5940, 2.7011, 2.7043, 2.7496,
                   2.8414, 2.8477, 2.8955, 2.9180, 2.9236, 2.9734, 2.9920, 3.0267,
                   3.0871, 3.1780, 3.1860, 3.2892, 3.3029, 3.3297, 3.3543, 3.4242,
                   3.6002, 3.6473, 3.6906, 3.7504, 3.7815, 3.9087, 3.9389, 4.0451,
                   4.0854, 4.2292, 4.2495, 4.2758, 4.2791, 4.3983, 4.4529, 4.5975,
                   4.6723, 4.8252, 4.8487, 4.8590, 4.8665, 4.9560, 5.0005, 5.0240,
                   5.1858, 5.1950, 5.3509, 5.5990, 5.6116, 5.6850, 5.7080, 5.7083,
                   5.7156, 5.8392, 6.0222, 6.1616, 6.3295, 6.4227, 6.4354, 6.4503,
                   6.5383, 6.8295, 6.8528, 7.0560, 7.1290, 7.1860, 7.3250, 7.3519,
                   7.3857, 7.3900, 7.5457, 7.6732, 7.8604, 7.8690, 7.9229, 8.0447,
                   8.0707, 8.0962, 8.2392, 8.3410, 8.4799, 8.7426, 8.7628, 8.8780,
                   9.1110, 9.2441, 9.2647, 9.5069, 9.9700, 10.1285, 10.2092,
                   ...
                   53.6166, 54.0453, 55.2306, 58.5199)
    mode_gains  = (0.0029, 0.0040, 0.0049, 0.0078, 0.0109, 0.0105, 0.0100, 0.0100,
                   0.0099, 0.0092, 0.0092, 0.0098, 0.0109, 0.0127, 0.0142, 0.0177,
                   0.0200, 0.0204, 0.0211, 0.0218, 0.0231, 0.0232, 0.0228, 0.0230,
                   0.0233, 0.0236, 0.0237, 0.0327, 0.0332, 0.0355, 0.0362, 0.0452,
                   0.0510, 0.0525, 0.0559, 0.0684, 0.0761, 0.0778, 0.0804, 0.0940,
                   0.0995, 0.0997, 0.1015, 0.0969, 0.0977, 0.0963, 0.0961, 0.0923,
                   0.0884, 0.0882, 0.0888, 0.0894, 0.0895, 0.0928, 0.0946, 0.0980,
                   0.1829, 0.2564, 0.2608, 0.3069, 0.3123, 0.3250, 0.3378, 0.3645,
                   0.5429, 0.5829, 0.5915, 0.5939, 0.5877, 0.5623, 0.5562, 0.3655,
                   0.2847, 0.1933, 0.1882, 0.1814, 0.1805, 0.1616, 0.1555, 0.1834,
                   0.2896, 0.4411, 0.4605, 0.4649, 0.4649, 0.4647, 0.4646, 0.4662,
                   0.4960, 0.5011, 0.5438, 0.7600, 0.7784, 0.7970, 0.7982, 0.7983,
                   0.7987, 0.7778, 0.6972, 0.6344, 0.2894, 0.2443, 0.2375, 0.2293,
                   0.1942, 0.1701, 0.1618, 0.1411, 0.1738, 0.2519, 0.3811, 0.4158,
                   0.4556, 0.4604, 0.6105, 0.7228, 0.8741, 0.8809, 0.9229, 0.9687,
                   0.9633, 0.9580, 0.9272, 0.8807, 0.8131, 0.9140, 0.9081, 0.8737,
                   0.8884, 0.9434, 0.9509, 0.9395, 0.7379, 0.6208, 0.6086, 0.6008,
                   0.5802, 0.7387, 0.7722, 0.7724, 0.7820, 0.7967, 0.9142, 0.9365,
                   1.0000, 0.9917, 0.9916, 0.9950, 0.9961, 0.9977, 0.9993, 0.9486,
                   0.9300, 0.9195, 0.9176, 0.8819, 0.8785, 0.8737, 0.8599, 0.7502,
                   0.7449, 0.7438, 0.7377, 0.6955, 0.6858, 0.6331, 0.5803, 0.5719,
                   0.5481, 0.5558, 0.5640, 0.5782, 0.5784, 0.5789, 0.5793, 0.5194,
                   0.5228, 0.5399, 0.5380, 0.5290, 0.5202, 0.5150, 0.4853, 0.4737,
                   0.4733, 0.4683, 0.4535, 0.4183, 0.4043, 0.3993, 0.3948, 0.3928,
                   0.4096, 0.4263, 0.4596, 0.4604, 0.4613, 0.4653, 0.4706, 0.4830,
                   0.4739, 0.4589, 0.4230, 0.4177, 0.4153, 0.3904, 0.3873, 0.3409,
                   0.3011, 0.2818, 0.2773, 0.2569, 0.2497, 0.2448, 0.2421, 0.2398,
                   0.2381, 0.2359, 0.2355, 0.2337, 0.2363, 0.2390, 0.2405, 0.2406,
                   0.2272, 0.2242, 0.2172, 0.2161, 0.2159, 0.1960, 0.1918, 0.1917,
                   0.1889, 0.1848, 0.1816, 0.1757, 0.1765, 0.1813, 0.1861, 0.1884,
                   0.1868, 0.1867, 0.1829, 0.1827, 0.1824, 0.1793, 0.1778, 0.1777,
                   0.1761, 0.1731, 0.1709, 0.1707, 0.1685, 0.1643, 0.1585, 0.1572,
                   0.1582, 0.1602, 0.1604, 0.1632, 0.1636, 0.1644, 0.1655, 0.1659,
                   0.1718, 0.1724, 0.1736, 0.1871, 0.1926, 0.1979, 0.2015, 0.2025,
                   0.2029, 0.2083, 0.2121, 0.2147, 0.2173, 0.2187, 0.2164, 0.2019,
                   0.1957, 0.1931, 0.1931, 0.1926, 0.1919, 0.1895, 0.1888, 0.1883,
                   0.1712, 0.1636, 0.1614, 0.1612, 0.1586, 0.1554, 0.1529, 0.1529,
                   0.1529, 0.1522, 0.1403, 0.1314)
    max_harmonic = 300
    decay_db = 108.636
    ...
    chiff_volume = 10.5569
    sustain_jitter = 0.149635
    chiff_width = 0.116775
...
class CrashCymbal2Properties(CymbalProperties):
    ...
    # Closing it means either enough modes to carry the sustain alone, or a
    # frequency-dependent wash decay in the kernel. Fit error 5.1 and 6.3 dB.
    mode_ratios = (1.0000, 1.0390, 1.1510, 1.1987, 1.2060, 1.2283, 1.2300, 1.2321,
                   1.2339, 1.2702, 1.2706, 1.3425, 1.3666, 1.3859, 1.4303, 1.4678,
                   1.4764, 1.4883, 1.5028, 1.5384, 1.5523, 1.5657, 1.6166, 1.6219,
                   1.6282, 1.6295, 1.7241, 1.7547, 1.7773, 1.8535, 1.8600, 1.8806,
                   1.8929, 1.9404, 1.9814, 2.0109, 2.0601, 2.0680, 2.0942, 2.0963,
                   2.1482, 2.2295, 2.3336, 2.3364, 2.3540, 2.3755, 2.4460, 2.4548,
                   2.4602, 2.5015, 2.5258, 2.5689, 2.6149, 2.6620, 2.6671, 2.8417,
                   2.8535, 2.8767, 2.8980, 2.9584, 3.1104, 3.1511, 3.1885, 3.2401,
                   3.2670, 3.3200, 3.3769, 3.4030, 3.4948, 3.5296, 3.6538, 3.6713,
                   3.6940, 3.6969, 3.7600, 3.7670, 3.7999, 3.8471, 3.9720, 4.0367,
                   4.1688, 4.1890, 4.2044, 4.3201, 4.4803, 4.4882, 4.6229, 4.6380,
                   4.6500, 4.8481, 4.9314, 4.9317, 4.9380, 5.0448, 5.0470, 5.2029,
                   5.3233, 5.4683, 5.5120, 5.5489, 5.5599, 5.5727, 5.6487, 5.9003,
                   5.9205, 6.3516, 6.3808, 6.3845, 6.5191, 6.6292, 6.7070, 6.7800,
                   6.7910, 6.8450, 6.8770, 6.9250, 6.9502, 6.9726, 6.9947, 7.0190,
                   7.0600, 7.1183, 7.1490, 7.1920, 7.3262, 7.5532, 7.5706, 7.7180,
                   7.9865, 8.0042, 8.2135, 8.6070, 8.6136, 8.7505, 8.8203, 8.8635,
                   8.8970, 8.9760, 9.0490, 9.1330, 9.2060, 9.2184, 9.2550, 9.4394,
                   9.5547, 9.7099, 9.7384, 9.9312, 10.1760, 10.3300, 10.3877,
                   10.8300, 10.9284, 10.9559, 11.0521, 11.0621, 11.1190, 11.1206,
                   11.2900, 11.4569, 11.4756, 11.5005, 11.8860, 12.0958, 12.1450,
                   12.3179, 12.8040, 12.9546, 13.0015, 13.3680, 13.4502, 13.6170,
                   13.6430, 13.9113, 13.9691, 14.0200, 14.4620, 14.4900, 14.5770,
                   14.8792, 15.0129, 15.0476, 15.2373, 15.2720, 15.3904, 15.3972,
                   15.5970, 15.6490, 16.0539, 16.2470, 16.5148, 16.6381, 16.6909,
                   16.8505, 16.9226, 17.1340, 18.1320, 18.1883, 18.7583, 18.7750,
                   18.8682, 18.9862, 19.1170, 19.1620, 19.2694, 19.4703, 19.6270,
                   19.6731, 20.4437, 20.5487, 20.5890, 20.6420, 20.9885, 21.3982,
                   21.6840, 21.8810, 22.3120, 22.4269, 22.8560, 22.9220, 23.0420,
                   23.3799, 23.7593, 23.9867, 24.2090, 24.4527, 24.8785, 24.9711,
                   25.1740, 25.3080, 25.3679, 25.5020, 26.2410, 26.5440, 26.8700,
                   26.9675, 27.1842, 27.2811, 27.4940, 27.5634, 27.7140, 27.7660,
                   28.5234, 28.9909, 29.0171, 29.4486, 29.4630, 29.9820, 30.0980,
                   30.8370, 30.9370, 31.1670, 31.3288, 31.8820, 32.1460, 32.4590,
                   32.8021, 32.8198, 33.0551, 33.1969, 33.7390, 33.8420, 34.0330,
                   34.9790, 35.0670, 35.1570, 35.2668, 35.7669, 35.9390, 36.0420,
                   36.1163, 36.4190, 37.0164, 37.3400, 37.4370, 37.8020, 38.6636,
                   38.8090, 39.0564, 39.2636, 39.3098, 39.6299, 40.0860, 40.2760,
                   40.4430, 40.8000, 42.6896, 42.7359, 42.9190, 43.1220, 43.3620,
                   43.5612, 44.2380, 44.5398, 45.7551, 45.9850, 46.3220, 46.6924,
                   47.7164, 50.5582)
    mode_gains  = (0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
                   ...
                   0.0005, 0.0007, 0.0008, 0.0008, 0.0009, 0.0008, 0.0008, 0.0008,
                   0.0008, 0.0008, 0.0008, 0.0009, 0.0010, 0.0010, 0.0010, 0.0014,
                   0.0014, 0.0014, 0.0015, 0.0017, 0.0032, 0.0038, 0.0044, 0.0056,
                   0.0066, 0.0084, 0.0098, 0.0105, 0.0130, 0.0159, 0.0321, 0.0333,
                   0.0349, 0.0351, 0.0404, 0.0411, 0.0444, 0.0491, 0.0560, 0.0516,
                   0.0450, 0.0440, 0.0433, 0.0346, 0.0406, 0.0424, 0.0640, 0.0650,
                   0.0658, 0.0725, 0.0754, 0.0754, 0.0756, 0.0710, 0.0706, 0.0473,
                   0.0725, 0.1568, 0.1841, 0.2057, 0.2120, 0.2192, 0.2603, 0.3506,
                   0.3538, 0.2606, 0.2467, 0.2448, 0.1585, 0.1388, 0.1213, 0.1213,
                   0.1214, 0.1219, 0.1221, 0.1215, 0.1200, 0.1186, 0.1172, 0.1156,
                   0.1128, 0.1088, 0.1107, 0.1133, 0.1212, 0.1496, 0.1635, 0.2543,
                   0.5935, 0.6123, 0.7539, 0.9692, 0.9711, 1.0000, 0.9624, 0.9381,
                   0.9187, 0.8708, 0.8335, 0.7940, 0.7575, 0.7512, 0.7319, 0.6016,
                   0.5043, 0.4119, 0.3923, 0.3553, 0.4459, 0.5338, 0.5633, 0.6636,
                   0.6777, 0.6816, 0.6951, 0.6944, 0.6862, 0.6860, 0.6608, 0.6482,
                   0.6487, 0.6494, 0.7552, 0.8563, 0.8561, 0.8552, 0.8574, 0.8202,
                   0.8082, 0.6928, 0.6606, 0.6079, 0.6086, 0.6155, 0.6170, 0.6164,
                   0.6036, 0.6024, 0.5985, 0.5834, 0.5737, 0.5711, 0.5569, 0.5542,
                   0.5260, 0.5243, 0.4729, 0.4585, 0.4651, 0.4795, 0.4924, 0.4982,
                   0.4979, 0.4715, 0.4590, 0.4203, 0.4037, 0.4025, 0.3785, 0.3786,
                   0.3790, 0.3796, 0.3802, 0.3804, 0.3809, 0.3886, 0.3960, 0.3982,
                   0.4215, 0.4244, 0.4255, 0.4271, 0.4369, 0.4182, 0.3966, 0.3853,
                   0.3619, 0.3552, 0.3285, 0.3242, 0.3162, 0.2945, 0.2696, 0.2632,
                   0.2568, 0.2505, 0.2546, 0.2554, 0.2568, 0.2518, 0.2496, 0.2445,
                   0.2262, 0.2242, 0.2262, 0.2277, 0.2311, 0.2326, 0.2351, 0.2333,
                   0.2293, 0.2279, 0.2139, 0.2152, 0.2153, 0.2207, 0.2209, 0.2291,
                   0.2287, 0.2215, 0.2208, 0.2212, 0.2215, 0.2229, 0.2255, 0.2286,
                   0.2311, 0.2308, 0.2261, 0.2232, 0.2118, 0.2133, 0.2168, 0.2263,
                   0.2249, 0.2235, 0.2218, 0.2137, 0.2101, 0.2078, 0.2061, 0.1991,
                   0.1871, 0.1842, 0.1834, 0.1800, 0.1604, 0.1565, 0.1494, 0.1466,
                   0.1461, 0.1427, 0.1377, 0.1357, 0.1348, 0.1329, 0.1112, 0.1106,
                   0.1083, 0.1056, 0.1024, 0.0996, 0.0921, 0.0902, 0.0826, 0.0812,
                   0.0792, 0.0774, 0.0777, 0.0686)
    max_harmonic = 300
    decay_db = 5.69981
    ...
    # Fitted to the clash trajectory at full velocity. The mode set is still this
    # plate's own recording; only how hard it is hit comes from the clash.
    chiff_volume = 13.7932
    sustain_jitter = 0.129348
    chiff_width = 0.312438
    # how much noisier this plate gets as it is struck harder, fitted so the
    # flatness at the mf velocity matches the mf recording.

...
class CrashCymbal1Properties(CymbalProperties):
    ...
    mode_gains  = (0.2943, 0.2538, 0.2602, 0.2612, 0.1983, 0.1748, 0.1748, 0.1471,
                   0.1435, 0.1416, 0.1129, 0.1128, 0.1080, 0.1008, 0.1071, 0.1122,
                   0.1199, 0.1195, 0.1189, 0.1180, 0.1167, 0.1114, 0.1073, 0.1015,
                   0.0892, 0.0891, 0.0890, 0.0890, 0.0981, 0.0989, 0.0999, 0.0974,
                   0.1052, 0.1145, 0.1169, 0.1219, 0.1387, 0.1454, 0.1463, 0.1478,
                   0.1628, 0.1658, 0.1657, 0.1601, 0.1422, 0.1420, 0.1311, 0.1305,
                   0.1225, 0.1123, 0.1118, 0.1105, 0.1102, 0.1102, 0.1122, 0.1138,
                   0.1166, 0.2139, 0.2933, 0.2978, 0.3432, 0.3484, 0.3609, 0.3736,
                   0.3989, 0.5814, 0.6213, 0.6279, 0.6273, 0.6193, 0.5873, 0.5799,
                   0.3789, 0.2946, 0.1988, 0.1934, 0.1862, 0.1853, 0.1653, 0.1588,
                   0.1867, 0.2942, 0.4470, 0.4665, 0.4710, 0.4709, 0.4700, 0.4697,
                   0.4712, 0.5004, 0.5055, 0.5479, 0.7644, 0.7828, 0.8012, 0.8023,
                   0.8024, 0.8027, 0.7813, 0.6998, 0.6365, 0.2902, 0.2450, 0.2381,
                   0.2299, 0.1946, 0.1704, 0.1621, 0.1413, 0.1740, 0.2522, 0.3816,
                   0.4163, 0.4562, 0.4610, 0.6110, 0.7234, 0.8747, 0.8816, 0.9236,
                   0.9693, 0.9639, 0.9586, 0.9277, 0.8812, 0.8135, 0.9144, 0.9085,
                   0.8740, 0.8886, 0.9436, 0.9511, 0.9397, 0.7380, 0.6209, 0.6086,
                   0.6009, 0.5803, 0.7387, 0.7722, 0.7724, 0.7820, 0.7968, 0.9142,
                   0.9365, 1.0000, 0.9917, 0.9915, 0.9949, 0.9960, 0.9977, 0.9993,
                   0.9485, 0.9300, 0.9195, 0.9176, 0.8819, 0.8785, 0.8736, 0.8599,
                   0.7501, 0.7448, 0.7438, 0.7377, 0.6954, 0.6858, 0.6331, 0.5803,
                   0.5718, 0.5480, 0.5558, 0.5639, 0.5781, 0.5783, 0.5788, 0.5792,
                   0.5194, 0.5227, 0.5399, 0.5379, 0.5289, 0.5202, 0.5149, 0.4853,
                   0.4736, 0.4733, 0.4683, 0.4535, 0.4182, 0.4043, 0.3993, 0.3948,
                   0.3928, 0.4095, 0.4262, 0.4596, 0.4603, 0.4613, 0.4653, 0.4706,
                   0.4830, 0.4739, 0.4588, 0.4230, 0.4177, 0.4153, 0.3904, 0.3873,
                   0.3409, 0.3011, 0.2817, 0.2773, 0.2568, 0.2497, 0.2448, 0.2421,
                   0.2398, 0.2381, 0.2359, 0.2354, 0.2337, 0.2362, 0.2389, 0.2404,
                   0.2405, 0.2272, 0.2241, 0.2172, 0.2161, 0.2159, 0.1959, 0.1918,
                   0.1916, 0.1889, 0.1848, 0.1816, 0.1756, 0.1765, 0.1813, 0.1861,
                   0.1884, 0.1868, 0.1867, 0.1829, 0.1826, 0.1824, 0.1793, 0.1778,
                   0.1777, 0.1761, 0.1730, 0.1709, 0.1707, 0.1685, 0.1643, 0.1585,
                   0.1572, 0.1582, 0.1602, 0.1604, 0.1632, 0.1636, 0.1644, 0.1654,
                   0.1659, 0.1718, 0.1724, 0.1736, 0.1871, 0.1926, 0.1979, 0.2015,
                   0.2025, 0.2029, 0.2083, 0.2120, 0.2147, 0.2173, 0.2187, 0.2164,
                   0.2019, 0.1957, 0.1931, 0.1931, 0.1926, 0.1919, 0.1895, 0.1888,
...
class CrashCymbal2Properties(CymbalProperties):
    ...
    mode_ratios = (1.0000, 1.0390, 1.1510, 1.1987, 1.1987, 1.2060, 1.2283, 1.2300,
                   ...
                   46.6924, 47.7164)
    mode_gains  = (0.0867, 0.1331, 0.1520, 0.1123, 0.1123, 0.1076, 0.0978, 0.0980,
                   0.0983, 0.0985, 0.1009, 0.1009, 0.1335, 0.1620, 0.1766, 0.2056,
                   0.2297, 0.2324, 0.2359, 0.2379, 0.2151, 0.2054, 0.1955, 0.1542,
                   0.1495, 0.1437, 0.1425, 0.0750, 0.0665, 0.0651, 0.0636, 0.0635,
                   0.0633, 0.0632, 0.0678, 0.0801, 0.0905, 0.0905, 0.0904, 0.1034,
                   0.1045, 0.1253, 0.1298, 0.1216, 0.1209, 0.1159, 0.1096, 0.0912,
                   0.0890, 0.0876, 0.0797, 0.0754, 0.0714, 0.0706, 0.0663, 0.0657,
                   0.0614, 0.0610, 0.0602, 0.0595, 0.0583, 0.0846, 0.0937, 0.1009,
                   0.1177, 0.1309, 0.1526, 0.1612, 0.1650, 0.1761, 0.2049, 0.3404,
                   0.3442, 0.3490, 0.3496, 0.3675, 0.3699, 0.3813, 0.3947, 0.3814,
                   0.3233, 0.2402, 0.2294, 0.2216, 0.1554, 0.1543, 0.1595, 0.2116,
                   0.2119, 0.2122, 0.1974, 0.1921, 0.1921, 0.1917, 0.1664, 0.1652,
                   0.0998, 0.1421, 0.2837, 0.3257, 0.3574, 0.3663, 0.3764, 0.4313,
                   0.5238, 0.5247, 0.3386, 0.3182, 0.3155, 0.1979, 0.1693, 0.1457,
                   0.1438, 0.1437, 0.1429, 0.1424, 0.1406, 0.1383, 0.1363, 0.1342,
                   0.1319, 0.1279, 0.1225, 0.1241, 0.1263, 0.1330, 0.1605, 0.1751,
                   0.2690, 0.6158, 0.6345, 0.7717, 0.9744, 0.9760, 1.0000, 0.9601,
                   0.9345, 0.9142, 0.8645, 0.8257, 0.7848, 0.7474, 0.7408, 0.7212,
                   0.5903, 0.4938, 0.4021, 0.3828, 0.3456, 0.4323, 0.5166, 0.5448,
                   0.6390, 0.6521, 0.6557, 0.6682, 0.6676, 0.6594, 0.6592, 0.6343,
                   0.6216, 0.6220, 0.6226, 0.7227, 0.8187, 0.8183, 0.8170, 0.8179,
                   0.7821, 0.7706, 0.6601, 0.6293, 0.5789, 0.5796, 0.5859, 0.5873,
                   0.5867, 0.5742, 0.5730, 0.5692, 0.5547, 0.5454, 0.5430, 0.5294,
                   0.5268, 0.5000, 0.4984, 0.4494, 0.4357, 0.4419, 0.4555, 0.4677,
                   0.4732, 0.4730, 0.4478, 0.4359, 0.3991, 0.3832, 0.3821, 0.3593,
                   0.3594, 0.3598, 0.3603, 0.3609, 0.3611, 0.3616, 0.3688, 0.3759,
                   0.3779, 0.4001, 0.4027, 0.4038, 0.4053, 0.4146, 0.3969, 0.3764,
                   0.3657, 0.3434, 0.3371, 0.3117, 0.3076, 0.3001, 0.2795, 0.2558,
                   0.2498, 0.2437, 0.2377, 0.2415, 0.2424, 0.2436, 0.2389, 0.2368,
                   0.2320, 0.2146, 0.2127, 0.2146, 0.2161, 0.2192, 0.2206, 0.2231,
                   0.2214, 0.2176, 0.2163, 0.2029, 0.2042, 0.2043, 0.2094, 0.2096,
                   0.2174, 0.2170, 0.2101, 0.2095, 0.2099, 0.2101, 0.2115, 0.2140,
                   0.2169, 0.2193, 0.2190, 0.2145, 0.2118, 0.2010, 0.2024, 0.2057,
                   0.2147, 0.2134, 0.2121, 0.2104, 0.2028, 0.1993, 0.1971, 0.1956,
                   0.1889, 0.1775, 0.1748, 0.1740, 0.1708, 0.1522, 0.1484, 0.1418,
                   0.1391, 0.1387, 0.1354, 0.1307, 0.1288, 0.1279, 0.1261, 0.1055,

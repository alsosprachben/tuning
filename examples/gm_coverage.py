...
PERC_RATED = {
 ...
 61:(2,"as 60, lower"), 62:(2,"a CONGA: a tall wooden cavity resonating at 128 Hz, BELOW its own 210 Hz head -- which is why a conga speaks from under the head. Muted; see 63"), 63:(2,"as 62, open -- percussion_map already rings the two differently, which is what a hand on the head does"), 64:(2,"as 62, the low drum"),

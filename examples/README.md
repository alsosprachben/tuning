...
| `clavinet.py` | A clavinet (GM 7), and `--compare` renders the same figure on the harpsichord it used to be. Both are bright keyboard strings and they are not the same instrument. |
